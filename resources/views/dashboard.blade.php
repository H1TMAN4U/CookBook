...
<section class="intro " style="height: 95vh;">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 " style="width: 100%;">
        <div id="indicators-carousel" class="relative" data-carousel="static" style="z-index: 0">
            <div class="relative overflow-hidden rounded-lg md:h-96 max-w-full h-auto" style="height: 30rem;">
                <div class="hidden duration-700 ease-in-out" data-carousel-item="active">
                    <img src="https://flowbite.com/docs/images/carousel/carousel-2.svg" class="absolute block w-full 
        ...
        <div>
            <h1 class="text-white text-4xl" style=" padding: 5% 15% 5% 15%; text-align: center;"
            >Lorem ipsum dolor sit amet, consectetur adipisicing elit. Libero at doloribus odit, cumque nemo voluptatem saepe sed deserunt omnis ea.</h1>
        </div>
    </div>
</section>
</x-app-layout>
